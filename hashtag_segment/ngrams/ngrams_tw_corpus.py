...
def avoid_long_words_tw(key,N_tw): # change N for changing default prob for words not in any corpus, N taken from global variable
    "Estimate the probability of an unknown word."
