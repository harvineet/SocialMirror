...
fd = open("feature_wengdata_modified_5509.csv", 'w')
fd.write("#globalAdoptersFollowers,#globalAdopters,#heavyusers,Density,LargestSize,NumEdges,Conduct1,Conduct2,Conduct3,Conduct4,Conduct2d,NumTweets,TimeFirst1000,NoOfAdopters,Conductance,RatioOfSingletons,RatioOfConnectedComponents,NumOfRT,NumOfMention,Class\n")
mention_line = "";
u2 = []
