...
if folder_contents==['mnt']:
	print 'mnt in', folder
	if "tweets" in folder:
		txtfile = folder.split('_')[0]+".txt"; # changed in case of tweets21_1
	else:
		txtfile = "tweets"+folder.split('_')[0]+".txt";
	path = "/mnt/filer01/Crawl1_extracts/TweetExtracts/"+folder+"/mnt/"+txtfile;
...
fe = io.open("/mnt/filer01/Crawl1_extracts/TweetExtracts/"+folder+"/errorfile_"+folder+".txt",'w',encoding='utf8')
f1 = io.open("/mnt/filer01/Crawl1_extracts/TweetExtracts/"+folder+"/tweetfile_"+folder+".txt",'w',encoding='utf8')
