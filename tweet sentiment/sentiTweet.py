#reads tweets before prediction threshold extracted from both crawls and queries sentiment140 service to classify sentiment contained in tweets
...
path_tweet_extracts = '../tweet_text/tweet_extracts_check/'
