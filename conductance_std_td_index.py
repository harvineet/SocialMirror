...
# u1 = []
tic = time.clock()
for pred_thr in [250,500,1000,1500]:#200,250,500,750,1000,
	fr = open('timeline_data/timeline_weng', 'r')
	fr1 = open('retweeteds_weng', 'r')
	fr2 = open('user_mentions_weng', 'r')
	fd=open("./conductance_std_features_td/std_100/feature_"+str(pred_thr)+".csv",'w')
	fd_cond=open("./conductance_std_features_td/std_100/cond_values_all/feature_"+str(pred_thr)+".csv",'w')
	fd.write("TagName,RatioSecondtoFirst,RatioSelfInitCommu,RatioCrossGeoEdges,#globalAdoptersFollowers,#globalAdopters,#heavyusers,Density,LargestSize,NumEdges,Conduct1,Conduct2,Conduct3,Conduct4,Conduct2d,NumTweets,TimeFirst1000,NoOfAdopters,Conductance,RatioOfSingletons,RatioOfConnectedComponents,InfectedCommunities,UsageEntropy,NumOfRT,NumOfMention,IntraRT,IntraMen,Conduct1_std,Conduct2_std,Conduct3_std,Conduct4_std,Conduct2d_std,Conductance_std,Conduct1_mvstd,Conduct2_mvstd,Conduct3_mvstd,Conduct4_mvstd,Conduct2d_mvstd,Conductance_mvstd,Class\n")
	if(pred_thr==200):
