...
path_tweet_extracts = '/mnt/filer01/Crawl1_extracts/extrafile_extracts'
...
tags_org = set()
fd = open("/twitterSimulations/tweet_text/tweet_text_check/tweets_selected_tags_crawl1_extra_"+fwritenum+".txt","w")
fd_err = open("/twitterSimulations/tweet_text/tweet_text_check/error_dump_crawl1_extra_"+fwritenum+".txt","w")
count = 0
