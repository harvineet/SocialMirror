...
tags_org = set()
fd = open("/twitterSimulations/tweet_text/tweets_selected_tags_round2_"+fwritenum+".txt","w")
fd_err = open("/twitterSimulations/tweet_text/error_dump_round2_"+fwritenum+".txt","w")
count = 0
