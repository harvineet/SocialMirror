...
dat<-fread("G:/socialnetworks_project_log/pred_thresh_change/std/featureThreshold.csv")
...
ggplot(dat, aes(FeatureSet, AUC)) +   
  ...
  scale_fill_grey() #scale_fill_brewer(palette="Blues") #scale_fill_brewer(palette="Greys")
